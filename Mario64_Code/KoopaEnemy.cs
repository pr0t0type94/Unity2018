...
public class KoopaEnemy : MonoBehaviour {
    ...
    IEnumerator killEnemy()
    {
        ...
        GameObject shell = Instantiate(shellPrefab, playerController.transform.position + Vector3.forward*4 + Vector3.up, Quaternion.identity);
        //shell.transform.position = playerController.transform.position;
